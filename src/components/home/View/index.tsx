...
export const OwnerView = () => {
    return ( 
              <>
           <Menu />
           <Text mt="10px" fontSize='l' fontWeight=' Bold' color='#03526B'>친구들에게 공유해 빙어를 추가해 보세요!</Text>
           <CopyLink />
           <Box  h='180px' />
           <FishingSpot />
...
export const ChefView = () => {
    ...
    return ( 
        ...
        <Text mt="10px" fontSize='l' fontWeight=' Bold' color='#03526B'>사랑하는 {nickname}의 호수를 채워주세요</Text>
        <AddToppingButton />
        <Box  h='180px' />
        <FishingSpot />
